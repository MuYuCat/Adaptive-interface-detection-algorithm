    function [surfaceLocation,depth,r] = skinDataProcessV4( filePath )
...
% line=1024;     % the times of B-scan    %B-Scan的数量
...
%            SeekBigIndex = JudgeBig;         % 重新赋值极大值的位置，防止原始数据丢失--用处不大
           ...
           while(flag)                
               ...
               if abs(maxIndex - max2Index) > 20  %10pixel = 325um.两个峰值不能小于25um--Day01的厚度--9Day为15--13Day为20
